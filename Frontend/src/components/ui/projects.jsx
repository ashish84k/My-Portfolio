...
const projects = [
  {
    ...
    description:
      "A MERN-based system to manage exhibitions, stalls, tickets, and payments with admin and user panels.",
  ...
  },
  {
    ...
    description:
      "React + Node.js based system for canteen orders, payments, and real-time management.",
  ...
  },
  {
    ...
    description:
      "Personal portfolio website with animations, contact form, and smooth UI/UX.",
  ...
  },
  {
    ...
    description:
      "A real-time chat app built using WebSocket/Socket.IO with features like user online/offline status, typing indicators, and message history.",
  ...
  },
  {
    ...
    description:
      "A full-featured task management application with user authentication, task creation, status tracking (Pending, In Progress, Completed), and deadline reminders.",
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8  text-white">
          {projects.map((project, index) => (
            <motion.div
              key={index}
              className="bg-gray-800 rounded-2xl shadow-lg p-6 flex flex-col justify-between border border-gray-700 hover:border-purple-500"
